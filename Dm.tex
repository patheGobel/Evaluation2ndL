...
\begin{enumerate}
    \item Calculer les expressions suivantes et donner les résultats sous la forme de fractions irréductibles :\textbf{0,75pt $\times$ 2}
    \[
    ...
    \item Écrire sous la forme \( a\sqrt{b} \) l’expression suivante :\textbf{0,75pt}
    \[
    2\sqrt{28} + 2\sqrt{63} + 3\sqrt{7}
    \]
    
    \item Écrire l’expression suivante sous la forme \( 2^m \times 5^n \times 7^p \) :\textbf{0,75pt}
    \[
